...
Summary(pl):	NarzÍdzia do obs≥ugi konsoli
Name:		console-tools
Version:	0.3.3
Release:	10
Epoch:		1
...
%description -l pl
Console-tools to narzÍdzia zajmuj±ce siÍ fontami i mapami klawiatury
na konsoli. Pakiet wywodzi siÍ z kbd-0.99.tar.gz, poprawiaj±c wiele
b≥ÍdÛw i wprowadzaj±c rozszerzenia. Pliki danych s± teraz czÍ∂ci±
...
Pliki nag≥Ûwkowe do console-tools.
